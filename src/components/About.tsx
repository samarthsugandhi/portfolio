        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <p className="text-slate-300 text-lg leading-relaxed">
              I&apos;m <span className="text-white font-semibold">Samarth Sugandhi</span>,
              a full-stack developer currently in my{" "}
              <span className="text-indigo-400 font-medium">
                6th semester at BEC (Information Science)
              </span>
              . I build real-world, production-grade systems — not side projects that never ship.
            </p>
            <p className="text-slate-400 leading-relaxed">
              From hackathons to classrooms, I&apos;ve built and deployed academic management
              systems, finance apps, event platforms, and more. I love working across the
              entire stack — architecting databases, designing APIs, and crafting
              pixel-perfect UIs.
            </p>
            <p className="text-slate-400 leading-relaxed">
              Right now, I&apos;m deeply exploring{" "}
              <span className="text-green-400 font-medium">AI agents</span> and intelligent
              automation — finding ways to integrate LLMs into real products that people
              actually use.
            </p>
          ...
          >
            ...
            >
              ...
              <p className="text-slate-300 font-medium">{personalInfo.currentlyBuilding}</p>
